...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield service.createBook(req.body);
...
const getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield service.getBooks();
        res.json(result);
    }
    catch (error) {
...
const getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield service.getBookById(id);
        res.json(result);
    }
    catch (error) {
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield service.updateBook(id, req.body);
        res.json(result);
    }
    catch (error) {
